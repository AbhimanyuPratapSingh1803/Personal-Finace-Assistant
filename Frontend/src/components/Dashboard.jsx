  ...
  return (
    <div className="space-y-6 bg-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-800 rounded-lg shadow-lg card-hover p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-green-200 text-xs">{summary.income.count} transactions</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg card-hover p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-red-200 text-sm font-medium">Total Expenses</p>
              <p className="text-2xl font-bold">{formatCurrency(summary.expense.total)}</p>
              <p className="text-red-200 text-xs">{summary.expense.count} transactions</p>
            </div>
        ...
        <div className={`bg-gray-800 rounded-lg shadow-lg card-hover p-6 text-white`}>
          <div className="flex items-center justify-between">
            ...
            <div className={`${summary.balance >= 0 ? "bg-blue-400" : "bg-red-400"} p-3 rounded-full`}>
      ...
      {/* Recent Transactions */}
      <div className="bg-gray-800 rounded-lg shadow-lg card-hover">
          ...
          {recentTransactions.length === 0 ? (
            ...
            <div className="space-y-4">
              {recentTransactions.map((transaction) => (
                <div
                  key={transaction._id}
                  className="flex items-center justify-between p-4 bg-gray-800 border-2 border-gray-600 rounded-lg hover:bg-gray-700 transition-colors"
                >
