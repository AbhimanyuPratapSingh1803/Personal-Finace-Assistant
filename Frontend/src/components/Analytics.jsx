  ...
  const trendChartOptions = {
    ...
    scales: {
      y: {
        ...
        grid: {
          color: 'rgba(255,255,255,0.2)', // 👈 optional faint white grid lines
        },
      },
      x: {
        ticks: {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 flex flex-col items-center justify-center text-white rounded-lg shadow-lg card-hover p-6">
          ...
          {categoryData.length > 0 ? (
            <div className="h-80 text-gray-200">
              <Pie data={pieChartData} options={pieChartOptions} className="text-white" />
            </div>
          ) : (
        ...
        {/* Spending Trends */}
        <div className="bg-gray-800  text-white rounded-lg shadow-lg card-hover p-6 lg:col-span-2">
          <div className="flex items-center space-x-2 mb-4">
      ...
      {categoryData.length > 0 && (
        <div className="bg-gray-800 text-white rounded-lg shadow-lg card-hover p-6">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y bg-gray-800 text-white divide-gray-200">
              ...
              <tbody className="bg-gray-800 divide-y divide-gray-200">
                {categoryData.map((item, index) => {
                  ...
                  return (
                    <tr key={index} className="bg-gray-800 hover:bg-gray-70">
