...
const ReceiptUpload = ({ onUploadSuccess, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-3xl flex items-center justify-center z-50">
      <div className="bg-gray-800 text-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          {/* Header */}
          ...
          {!uploadResult && (
            <div className="space-y-4">
              ...
              {/* Selected File Info */}
              {file && (
                <div className="bg-gray-800 border border-green-200 rounded-lg p-3">
              ...
              {/* Error Message */}
              {error && (
                <div className="bg-gray-800 border border-red-200 rounded-lg p-3">
                  <div className="flex items-center">
                    <AlertCircle className="h-4 w-4 text-red-200 mr-2" />
              ...
              {/* Instructions */}
              <div className="bg-gray-800 border border-gray-200 rounded-lg p-4">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="bg-yellow-500 hover:bg-yellow-600 disabled:bg-yellow-300 text-black font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                ...
                <button
                  ...
                  disabled={!file || uploading}
                  className="flex-1 bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-black font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                  {uploading ? (
                    <>
                ...
                <button
                  onClick={onClose}
                  className="bg-gray-300 hover:bg-gray-400 text-black font-medium py-3 px-4 rounded-lg transition-colors"
                >
                  Cancel
                </button>
              </div>
